...
W literaturze predmiotu preferowane są modele o największej czułości. Wybrany alfabet zapewnia zarówno największą czułość jak i AUC.
...
PCA: przedstawone na rysunku dwa pierwsze komponenty składowe wyjaśniają 40\% wariancji.
